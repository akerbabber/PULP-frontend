    ...
    <div>
     ...
     <Header />
      <div className='font-ProtoMono-Light  text-center w-full h-full pt-[3vw] flex-col bg-gradient-to-b from-orange-400 to-yellow-300 text-white'>
        <div className='text-[3vw] font-ProtoMono-SemiBold  text-center mb-[5vw] mt-[2vw] '>
        ...
        <div className='font-ProtoMono-Light text-[1.3vw] w-[93%] h-[5vw] mt-20 mb-[6vw] text-center flex justify-around ' id="bottomMenu">
