  ...
  return (
   ...
   <Header />
      ...
      <div className='rounded-[150px]    bg-white w-[78%] h-[20vw] m-auto p-20'>
          ...
          <button onClick={() => router.push("/checkedbox")} className='rounded-lg text-[1.2vw] p-4 bg-white border-2 border-green-900 mt-[3vw] text-gray-900 hover:bg-green-900 hover:text-white'>Continue</button>
